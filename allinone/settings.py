...
SUPPORT_EMAIL = os.getenv('SUPPORT_EMAIL', CONTACT_RECEIVER_EMAIL)
BUSINESS_EMAIL = os.getenv('BUSINESS_EMAIL', CONTACT_RECEIVER_EMAIL)
CONTACT_PHONE = os.getenv('CONTACT_PHONE', '')
CONTACT_WHATSAPP = os.getenv('CONTACT_WHATSAPP', '')
CONTACT_ADDRESS = os.getenv('CONTACT_ADDRESS', '')
SUPPORT_RESPONSE_TIME = os.getenv('SUPPORT_RESPONSE_TIME', 'We usually respond within 1–2 business days.')
